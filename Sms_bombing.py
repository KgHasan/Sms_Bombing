...
def update():
    ...
    try:
        mainVersion = requests.get("https://raw.githubusercontent.com/Kg-Hasan/HasanBombar/main/more/.version").text
    except:
    ...
    os.system("cd .. && rm -rf HasanBomber && git clone https://github.com/KgHasan/HasanBombar > /dev/null 2>&1")
    
    psb("\n\033[92m    [\033[37m*\033[92m] Update Complete!")
    psb("\033[92m    [\033[37m*\033[92m] Starting Tool...")
    time.sleep(0.8)
    
    os.system("cd .. && cd HasanBomber && python Tbomb.py")
...
╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═══╝
    ...
    print("\033[94m│ \033[95mAuthor : ×͜× Ꮋᴀꜱᴀɴ ™                     \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/KgHasan \033[94m│".center(columns+9))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mKgHasaN\n")
        time.sleep(0.6)
