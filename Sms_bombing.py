...
def update():
    ...
    try:
        mainVersion = requests.get("https://raw.githubusercontent.com/Toxic-Noob/KgHasan/main/more/.version").text
    except:
    ...
    os.system("cd .. && rm -rf KgHasan && git clone https://github.com/Toxic-Noob/KgHasan > /dev/null 2>&1")
    
    psb("\n\033[92m    [\033[37m*\033[92m] Update Complete!")
    psb("\033[92m    [\033[37m*\033[92m] Starting Tool...")
    time.sleep(0.8)
    
    os.system("cd .. && cd KgHasan && python Tbomb.py")
...
\/ /_/ \__,_|___/\__,_| \_\ \/  
 ...
 \033[94m   │".center(columns+15))
    ...
    print("\033[94m│ \033[95mAuthor : KgHasan                     \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : KgHasan
